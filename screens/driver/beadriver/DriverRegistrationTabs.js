...
import WorkingDates from './DriverWorkingDates';
const { width, height } = Dimensions.get('screen');

class DriverRegistrationTabs extends React.Component {
  ...
  render() {
    const { filters } = this.state;
    const currentTab = filters.type === 'workingdates'?<WorkingDates/>: <DriverRegistration/>;
...
export default DriverRegistrationTabs;
